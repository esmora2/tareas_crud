...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference("Tarea.count") do
      post tareas_url, params: { tarea: { completada: @tarea.completada, description: @tarea.description, titulo: @tarea.titulo } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { completada: @tarea.completada, description: @tarea.description, titulo: @tarea.titulo } }
